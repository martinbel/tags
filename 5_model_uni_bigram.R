...
save(fit, file='../tags/model/lasso_uni_bi_gram.rdt')
...
# Metrics plot
png(file='../tags/model/model_metrics_bigram.png', width = 500, height = 700, res=100)
par(mfrow=c(3,1))
...
write.table(predictions, file='../tags/data/predictions_uni_bi_gram.csv')
